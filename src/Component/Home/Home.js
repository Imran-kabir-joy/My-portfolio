...
import pdf from '../../File/Resume_imran.pdf'
        ...
        <React.Fragment >
            <div>
                ...
                <img className={classes.circle} src={img} alt="myImage" />
                    <animated.h3 style={props}> Md Imran Kabir Joy</animated.h3>
                </Typography>
                <Typography variant="h6" color="textSecondary" component="p" gutterBottom>
                    <Typist>
                    Web Developer ||  JavaScript Developer || BG: B+(ve)
                    </Typist> 
                </Typography>
                <Link className={classes.textDecoration} href={pdf} target="_blank" download="Resume_imran.pdf">
